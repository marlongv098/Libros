...
* Modifica el método ejecutarOperaciones() para comparar mySet2 y mySet4. De-
termina qué elementos están en mySet2 pero no en mySet4, y luego imprime el
resultado.

* El código no muestra explícitamente el método removeAll() en realizarOperaciones-
Texto. Dados los datos iniciales, si se realizara una operación removeAll() sobre la
